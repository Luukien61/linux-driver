...
static const struct file_operations myfs_file_operations = {
	...
	.splice_read  = generic_file_splice_read, // Đọc dữ liệu qua splice
	.splice_write = iter_file_splice_write,   // Ghi dữ liệu qua splice
...
static const struct address_space_operations myfs_aops = {
	.readpage    = simple_readpage,    // Đọc một trang dữ liệu
	.write_begin = simple_write_begin, // Bắt đầu ghi dữ liệu
	.write_end   = simple_write_end,   // Kết thúc ghi dữ liệu
};
